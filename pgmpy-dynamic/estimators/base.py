...
class BaseEstimator(object):
    ...
    #----------------------------------------------------------------------------------------------
	# Implementation of calculate_t_data function for Dynamic Bayesian Networks 
    ...
    def state_counts_dynamic(self, variable, parents=[], Data=None, complete_samples_only=None):
        """
        ...
        data = Data.dropna() if complete_samples_only else self.data.dropna(subset=[variable] + parents)
        ...
        if not parents:
            ...
            parents_states = [self.state_names[parent] for parent,temp in parents]
    ...
    def state_counts(self, variable, parents=[], Data=None, complete_samples_only=None):
