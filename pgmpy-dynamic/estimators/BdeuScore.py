...
class BdeuScore(StructureScore):
    def __init__(self, data, nodes=None, bk1=None, bk2=None, weight=0, equivalent_sample_size=10, **kwargs):
        """
        ...
        nodes: list of strings 
        	string list containing the data node names.
    ...
    def local_score(self, variable, parents, bData=None):
        ...
        if bk1 is None and bk2 is None:
            ...
            return score + (weight*soma_score)
